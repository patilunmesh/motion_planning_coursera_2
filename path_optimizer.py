...
class PathOptimizer:
    ...
    def optimize_spiral(self, xf, yf, tf):
        ...
        # TOODO: INSERT YOUR CODE BETWEEN THE DASHED LINES
        # ------------------------------------------------------------------
        res = scipy.optimize.minimize(fun= self.objective, x0= p0, method = 'L-BFGS-B', jac = self.objective_grad, constraints = bounds)
        # ------------------------------------------------------------------
    ...
    def thetaf(self, a, b, c, d, s):
        ...
        thetas = thetas = a*s + b/2*s^2 + c/3*s^3 + d/4*s^4
    ...
    def sample_spiral(self, p):
        ...
        # TODO: INSERT YOUR CODE BETWEEN THE DASHED LINES
        # ------------------------------------------------------------------
        t_points = thetaf(self, a, b, c, d, s_points)
